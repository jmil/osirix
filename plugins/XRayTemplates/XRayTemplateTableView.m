...
#import "XRayTemplateTableView.h"
#import "NSImage+XRayTemplatePlugin.h"

@implementation XRayTemplateTableView
...
//	NSRect croppingRect = [windowController boundingBoxOfImage:image0 withBackgroundColor:[NSColor colorWithCalibratedRed:0 green:0 blue:0 alpha:0]];
	NSRect croppingRect = [windowController boundingBoxOfImage:image0];

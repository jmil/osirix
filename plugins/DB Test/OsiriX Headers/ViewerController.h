...
//	IBOutlet NSWindow		*singleWindow;
	IBOutlet StudyView		*studyView;
//	IBOutlet SeriesView		*seriesView;
	...
	IBOutlet NSMatrix		*roiPropaMode, *roiPropaDim;
...
- (id) initWithWindowNibName:(NSString *)nibName :(NSMutableArray *)f :(NSMutableArray *)d :(NSData *) v;

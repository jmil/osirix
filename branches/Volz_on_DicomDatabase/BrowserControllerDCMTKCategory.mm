...
- (NSData*) getDICOMFile:(NSString*) file inSyntax:(NSString*) syntax quality: (int) quality { // deprecated, moved to DicomDatabase
	return [self.database getDICOMFile:file inSyntax:syntax quality:quality];
}
